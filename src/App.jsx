...
const CHORD_SHAPES = {
  ...
  I: [
    ...
    },
    {
      ...
      voicings: {
        ...
        A_open:     { frets:[null,0,2,0,2,2],     fingers:"A9 open — fat funk sound", barre:null },
        moveable_E: { frets:[1,3,1,2,1,3],        fingers:"Barre E9 shape — full moveable voicing", barre:1 },
        moveable_A: { frets:[null,1,3,1,3,3],     fingers:"Barre A9 shape — moveable", barre:1 },
    ...
    },
    {
      ...
      voicings: {
        ...
        A_open:     { frets:[null,0,2,0,1,0],      fingers:"A7b9 open — very bluesy", barre:null },
        moveable_E: { frets:[1,3,1,2,1,2],         fingers:"Barre E7b9 — moveable", barre:1 },
        moveable_A: { frets:[null,1,3,1,2,1],      fingers:"Barre A7b9 — moveable", barre:1 },
    ...
    },
    {
      ...
      voicings: {
        ...
        moveable_A: { frets:[null,1,3,1,3,4],       fingers:"Barre A13 — moveable", barre:1 },
  ...
  IV: [
    ...
    },
    {
      ...
      tones: "R · 3 · 5 · b7 · 9",
      voicings: {
        A_open:     { frets:[null,0,2,0,2,2],        fingers:"A9 open", barre:null },
        ...
        moveable_A: { frets:[null,1,3,1,3,3],        fingers:"A9 barre shape", barre:1 },
    ...
    },
    {
      ...
      tones: "R · 3 · 5 · 6",
      voicings: {
        A_open:     { frets:[null,0,2,2,2,0],        fingers:"A6 open — warm and inviting", barre:null },
        E_open:     { frets:[0,2,2,1,2,0],           fingers:"E6 open", barre:null },
        D_open:     { frets:[null,null,0,2,0,2],     fingers:"D6 — sweet and clear", barre:null },
        moveable_A: { frets:[null,1,3,3,3,1],        fingers:"A6 barre shape", barre:1 },
        moveable_E: { frets:[1,3,3,1,2,1],           fingers:"E6 barre shape", barre:1 },
  ...
  V: [
    ...
    },
    {
      ...
      voicings: {
        ...
        B_shape:    { frets:[null,2,4,2,3,2],        fingers:"B7b9 barre shape", barre:2 },
        moveable_E: { frets:[1,3,1,2,1,2],           fingers:"E7b9 barre — moveable", barre:1 },
        moveable_A: { frets:[null,1,3,1,2,1],        fingers:"A7b9 barre — moveable", barre:1 },
    ...
    },
    {
      ...
      voicings: {
        ...
        B_shape:    { frets:[null,2,4,2,4,4],        fingers:"B9 barre — 2nd position", barre:2 },
        moveable_A: { frets:[null,1,3,1,3,3],        fingers:"A9 barre shape", barre:1 },
    ...
    },
    {
      ...
      voicings: {
        ...
        B_shape:    { frets:[null,2,4,2,4,5],        fingers:"B13 barre — 2nd position", barre:2 },
        moveable_A: { frets:[null,1,3,1,3,4],        fingers:"A13 barre", barre:1 },
  ...
  im: [
    ...
    },
    {
      ...
      tones: "R · b3 · 5 · b7 · 9",
      voicings: {
        Am_open:    { frets:[null,0,2,0,1,2],        fingers:"Am9 open — neo-soul minor blues", barre:null },
        Em_open:    { frets:[0,2,0,0,3,0],           fingers:"Em9 open — beautiful and spacious", barre:null },
        moveable_A: { frets:[null,1,3,1,2,3],        fingers:"Moveable Am9 shape", barre:1 },
    ...
    },
    {
      ...
      tones: "R · b3 · b5 · b7",
      voicings: {
        Am_shape:   { frets:[null,0,1,2,1,0],        fingers:"Am7b5 open — haunting", barre:null },
        ...
        moveable_E: { frets:[1,2,3,1,3,null],        fingers:"E shape m7b5 moveable", barre:null },
    ...
    },
    {
      ...
      voicings: {
        ...
        Em_open:    { frets:[0,2,0,0,0,0],           fingers:"Em11 — very open, all strings ring", barre:null },
        moveable_A: { frets:[null,1,3,1,3,3],        fingers:"Moveable m11 shape", barre:1 },
    ...
    },
    {
      ...
      voicings: {
        ...
        moveable_E: { frets:[1,3,3,1,2,null],        fingers:"E shape m6 — moveable", barre:1 },
  ...
  IVm: [
    ...
    },
    {
      ...
      voicings: {
        ...
        Am_open:    { frets:[null,0,2,0,1,2],        fingers:"Am9 open shape", barre:null },
        moveable_A: { frets:[null,1,3,1,2,3],        fingers:"Moveable m9 barre", barre:1 },
